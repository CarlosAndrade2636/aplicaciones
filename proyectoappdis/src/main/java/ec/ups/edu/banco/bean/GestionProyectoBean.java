...
public class GestionProyectoBean implements Serializable{
	...
	public String iniciarSesion() {
		System.out.println("----------------usuario aqui "+usuario.getEmailUsuario());
		for(Usuario us:listaUsuarios) {
			
			System.out.println("------ us  "+ us.getEmailUsuario());
			System.out.println("------ us contra  "+ us.getContraseniaUsuario());
			System.out.println("------ contra web "+ usuario.getContraseniaUsuario());
			System.out.println("------ us email  "+ us.getEmailUsuario());
			System.out.println("------ contra email "+ usuario.getEmailUsuario());
